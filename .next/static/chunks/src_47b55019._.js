(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_47b55019._.js", {
...
"[project]/src/components/ui/displaycourseratings.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DisplayCourseRatings = ()=>{
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DisplayCourseRatings.useEffect": ()=>{
            const fetchUserData = {
                "DisplayCourseRatings.useEffect.fetchUserData": async ()=>{
                    const { data: { session }, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (sessionError || !session?.user) {
                        setError('You are not logged in');
                        setLoading(false);
                    ...
                    setUser(session.user);
                    const { data: userRatings, error: ratingsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('golf_outings').select('course_name, course_rating').eq('player_id', session.user.id);
                    if (ratingsError) {
            ...
            }["DisplayCourseRatings.useEffect.fetchUserData"];
            fetchUserData();
        }
    }["DisplayCourseRatings.useEffect"], []);
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/components/ui/displaycourseratings.jsx",
        lineNumber: 46,
        columnNumber: 25
    }, this);
    if (error) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "course-ratings-container",
        children: user && ratings.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "course-ratings-grid",
            ...
            children: "You haven't added any course ratings yet."
        }, void 0, false, {
            fileName: "[project]/src/components/ui/displaycourseratings.jsx",
            lineNumber: 68,
            columnNumber: 25
...
_s(DisplayCourseRatings, "JYZX26dzeRf9NCg28VTKShkJqGQ=");
_c = DisplayCourseRatings;
const __TURBOPACK__default__export__ = DisplayCourseRatings;
var _c;
__turbopack_context__.k.register(_c, "DisplayCourseRatings");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_47b55019._.js.map