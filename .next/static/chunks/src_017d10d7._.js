(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_017d10d7._.js", {
...
function AuthPage() {
    ...
    const handleAuth = async (e)=>{
        ...
        const { error } = isSignUp ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password
        }) : await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email,
            password
        });
        if (error) {
...
_s(AuthPage, "zURZJgwBamdLZaTugDgYaohN0AU=", false, function() {
    return [
...
//# sourceMappingURL=src_017d10d7._.js.map